...
// --- SUB-COMPONENT: MANEUVER CARD ---
const ManeuverCard = ({ event, videoUrl, telemetry, isPro, isLocked }: { event: any, videoUrl: string, telemetry: any[], isPro: boolean, isLocked: boolean }) => {
...
export default function ResultsPage(){
  ...
  const { user, isPro, togglePro } = useAuth(); 
